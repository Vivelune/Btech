...
const serviceDescriptions: Record<string, string> = {
  "Digital Solutions":
    "Cloud infrastructure & digital transformation for modern enterprises.",
  "Web Development":
    "High-performance websites and web apps built with modern frameworks.",
  "App Development":
    "Native and cross-platform mobile apps with seamless UX.",
  "Digital Marketing":
    "Data-driven campaigns across search, social, and content channels.",
  "Logo Design":
    "Brand identities and visual systems that make lasting impressions.",
  "Form Builder":
    "Custom forms with integrations, validation, and analytics.",
};
  ...
  return (
    <main
      ...
      style={{
        ...
        background:
          "linear-gradient(145deg, #060E1A 0%, #081A14 50%, #071220 100%)",
      }}
    >
      ...
      >
        <Link
          ...
          onMouseLeave={(e) =>
            (e.currentTarget.style.color = "#7BAFC4")
          }
        >
        ...
        <div className="flex flex-col lg:flex-row gap-7 items-start">
          ...
          <div className="gsap-left opacity-0 hidden lg:flex lg:w-[42%] flex-shrink-0 flex-col gap-5">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(160deg, rgba(13,33,65,0.95) 0%, rgba(9,37,30,0.95) 60%, rgba(11,25,50,0.95) 100%)",
                border:
                  "1px solid rgba(52,211,153,0.18)",
                boxShadow:
                  "0 0 60px rgba(29,78,216,0.15), 0 0 40px rgba(16,185,129,0.08), inset 0 1px 0 rgba(255,255,255,0.06)",
            ...
            >
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, transparent, rgba(52,211,153,0.4), rgba(96,165,250,0.3), transparent)",
                }}
              />
              ...
              <div className="relative z-10">
                ...
                >
                  ...
                  <span
                    ...
                    style={{
                      backgroundImage:
                        "linear-gradient(110deg, #34D399 0%, #2DD4BF 40%, #60A5FA 80%)",
                    }}
                  >
                    great together.
                  </span>
                ...
                <p
                  ...
                  style={{ color: "#7BAFC4" }}
                >
                  Describe your project and we'll connect you with
                  the right team. Most enquiries get a personal reply
                  ...
                  {[
                    {
                      ...
                      label: "info@btechsolutions.com",
                    },
                    {
                      icon: <Clock className="w-4 h-4" />,
                      label: "Mon – Fri, 9 am – 6 pm GMT",
                    },
                    {
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(90deg, transparent, rgba(52,211,153,0.2), rgba(96,165,250,0.15), transparent)",
                  }}
                />
                    ...
                    <button
                      ...
                      style={
                        activeService === s.label
                          ? {
                              background:
                                "linear-gradient(110deg, rgba(52,211,153,0.25), rgba(96,165,250,0.2))",
                              border:
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(13,33,65,0.9) 0%, rgba(9,37,30,0.9) 100%)",
                border:
            ...
            >
              ...
              <div>
                ...
                <p
                  ...
                  style={{ color: "#7BAFC4" }}
                >
                  Every submission gets a personal reply — no bots,
                  no templates.
                </p>
              </div>
            </div>
          ...
          <div className="gsap-right opacity-0 w-full lg:flex-1 max-w-2xl mx-auto lg:max-w-none lg:mx-0">
            <div
              ...
              style={{
                background:
                  "linear-gradient(160deg, rgba(11,28,60,0.97) 0%, rgba(8,32,26,0.97) 55%, rgba(10,22,48,0.97) 100%)",
                border:
                  "1px solid rgba(52,211,153,0.2)",
                boxShadow:
                  "0 0 80px rgba(29,78,216,0.18), 0 0 50px rgba(16,185,129,0.1), inset 0 1px 0 rgba(255,255,255,0.07)",
            ...
            >
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, transparent, rgba(96,165,250,0.5), rgba(52,211,153,0.5), transparent)",
                }}
              />
                ...
                <div className="relative z-10">
                  ...
                  >
                    ...
                    <button
                      ...
                      style={{
                        background:
                          "linear-gradient(110deg, #1a6b4a 0%, #1D4ED8 50%, #0e7c5a 100%)",
                        backgroundSize: "200% auto",
                        color: "#E8F4FF",
                        boxShadow:
                          "0 4px 24px rgba(52,211,153,0.25), 0 2px 12px rgba(29,78,216,0.2)",
                        border:
                          "1px solid rgba(52,211,153,0.3)",
                      }}
                      onMouseEnter={(e) => {
                        ...
                        e.currentTarget.style.boxShadow =
                          "0 6px 32px rgba(52,211,153,0.4), 0 2px 16px rgba(29,78,216,0.3)";
                      }}
                      onMouseLeave={(e) => {
                        e.currentTarget.style.backgroundPosition =
                          "left center";
                    ...
                    <p
                      ...
                      style={{ color: "#3D6B7A" }}
                    >
                      We respect your privacy. Your details are
