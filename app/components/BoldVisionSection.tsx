export default function BoldVisionSection() {
  return (
    <>
      ...
      <section
        className="relative flex min-h-dvh w-full items-center justify-center overflow-hidden px-4 py-16 sm:px-6 sm:py-20"
        style={{ background: "#edf5ee", fontFamily: "'DM Sans', sans-serif" }}
      >
