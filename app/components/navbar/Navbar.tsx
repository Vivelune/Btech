    ...
    links: [
      {
        ...
        desc: "Custom Next.js builds",
        href: "/#digital-marketing-section",
      },
      {
        title: "Web Development",
        desc: "Product & UI systems",
        href: "/#web-development-section",
      },
      {
        title: "App Development",
        desc: "Search visibility & growth",
        href: "/#mobile-app-section",
      },
      {
...
export default function Navbar({ className }: { className?: string }) {
  ...
  // -------------------------------------------------------------------------
  // NEW: Get role from Prisma through /api/role
  // -------------------------------------------------------------------------
          ...
          {query.trim() ? (
            ...
            <>
              ...
              {NAV_ITEMS.map((item) => (
                <div
                  key={item.label}
                  className="border-b border-white/[0.06] py-2 last:border-none"
                >
